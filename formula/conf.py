...
project = u'stats306b'
copyright = u'2010, Jonathan Taylor, based on matplotlib sampledoc of John Hunter, Fernando Perez, Michael Droettboom'
...
# Include snippets of R code
rcode_include_rcodes = True
